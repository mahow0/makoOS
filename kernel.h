...
// Idioms used here
// do-while loop + backslash used here to define a multi-line macro
// ## before __VA_ARGS__ allows the comma to be omitted if VA_ARGS is empty
// while (1) blocks execution
#define PANIC(fmt, ...)                                                         \
    do {                                                                        \
